...
library ZKState {
  ...
  /**
   * @notice Get bombsCommitment.
   */
  function getBombsCommitment() internal view returns (uint32 bombsCommitment) {
   ...
   * @notice Get bombsCommitment.
   */
  function _getBombsCommitment() internal view returns (uint32 bombsCommitment) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  /**
   * @notice Set bombsCommitment.
   */
  function setBombsCommitment(uint32 bombsCommitment) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((bombsCommitment)), _fieldLayout);
  }

  /**
   * @notice Set bombsCommitment.
   */
  function _setBombsCommitment(uint32 bombsCommitment) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreCore.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((bombsCommitment)), _fieldLayout);
  }
   ...
   */
  function set(uint32 bombsCommitment, address circomVerifier) internal {
    bytes memory _staticData = encodeStatic(bombsCommitment, circomVerifier);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(uint32 bombsCommitment, address circomVerifier) internal {
    bytes memory _staticData = encodeStatic(bombsCommitment, circomVerifier);
  ...
  function set(ZKStateData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.bombsCommitment, _table.circomVerifier);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (uint32 bombsCommitment, address circomVerifier) {
    bombsCommitment = (uint32(Bytes.getBytes4(_blob, 0)));
  ...
  function decode(
    ...
    (_table.bombsCommitment, _table.circomVerifier) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(uint32 bombsCommitment, address circomVerifier) internal pure returns (bytes memory) {
    return abi.encodePacked(bombsCommitment, circomVerifier);
  }
